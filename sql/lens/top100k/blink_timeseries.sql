...
FROM
  ...
  (SELECT _TABLE_SUFFIX, COUNT(DISTINCT url) as total FROM `httparchive.summary_pages.*` WHERE rank <= 100000 and _TABLE_SUFFIX >= '2021_05_01' GROUP BY _TABLE_SUFFIX) AS t
WHERE
